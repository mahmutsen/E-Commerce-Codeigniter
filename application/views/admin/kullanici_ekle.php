...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Kullanıcı Ekleme</a></li>
			</ul>
						...
						<form class="form-horizontal"action="<?=base_url()?>admin/Kullanicilar/eklekaydet" method="post">
							<fieldset>
							  <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="adsoy">
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="focusedInput">Şifre</label>
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="password" name="sifre">
								</div>
							  </div>
							  <div class="control-group">
							  ...
							  <div class="form-actions">
								...
								<a class="btn btn-danger" href="<?=base_url()?>admin/Kullanicilar">Iptal</a>
							  </div>
							</fieldset>
						  </form>
